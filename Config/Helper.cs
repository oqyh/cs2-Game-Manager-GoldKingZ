...
public class Helper
{
    ...
    public static void ExectueCommands()
    {
        ...
        if(Configs.GetConfigData().DisableCashAwardsAndMoneyHUD)
        {
            Server.ExecuteCommand("mp_playercashawards 0; mp_teamcashawards 0; cash_team_bonus_shorthanded 0");
        }
    ...
    public static void ExectueCommandsSvCheats()
    {
